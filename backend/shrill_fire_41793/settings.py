"""
Django settings for shrill_fire_41793 project.
...
ROOT_URLCONF = 'shrill_fire_41793.urls'
...
WSGI_APPLICATION = 'shrill_fire_41793.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shrill_fire_41793 API",
    "DESCRIPTION": "API documentation for shrill_fire_41793 App",
    "VERSION": "v1",
}
